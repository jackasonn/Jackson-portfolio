...
The project also connects upkeep to the wider creative process. Songs, interfaces, websites and visual systems all need attention over time. Things need to be adjusted, repaired, reworked and sometimes rebuilt. Repair / Decay makes that normally hidden labour visible to the audience by allowing the work to break and asking them to participate in keeping it going. It is still being developed, so the final interaction, visuals and musical systems are continuing to evolve as the team tests what makes the experience engaging, understandable and meaningful.",
